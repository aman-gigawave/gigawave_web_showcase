...
function PhoneInputInput(
  ...
  return (
    <PhoneInputPrimitive.Input data-slot="phone-input-input" asChild {...props}>
      {React.useMemo(
        () => (
          <Input className="no-spinner w-full placeholder:!text-white/60 focus-within:!outline-none shadow-none outline-none !text-sm !p-0 focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-offset-0 font-bold !text-neutral-200  bg-clip-text" />
        ),
        []
      )}
