...
const LiquidButton = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className="relative">
      <div
        className="absolute top-0 left-0 z-0 h-full w-full  rounded-2xl sm:rounded-[26px] 
      ...
      />
      <div
        className="absolute top-0 left-0 isolate -z-10 h-full w-full overflow-hidden rounded-2xl sm:rounded-[26px]"
